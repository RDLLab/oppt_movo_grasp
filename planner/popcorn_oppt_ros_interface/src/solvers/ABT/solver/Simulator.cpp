...
double Simulator::runSimulation(std::ofstream& os)
{
...
{   
    ...
    double impSolTimeStart = oppt::clock_ms();
    long numHistories = 0;
    ...
    double replenishTimeStart = oppt::clock_ms();
    ...
    double repTime = oppt::clock_ms() - replenishTimeStart;    
    ...
    if (static_cast<oppt::ABTExtendedOptions const*>(options_)->pruneEveryStep) {
        double pruningTimeStart = oppt::clock_ms();
