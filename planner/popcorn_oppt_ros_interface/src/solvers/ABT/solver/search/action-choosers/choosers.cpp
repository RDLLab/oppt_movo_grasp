...
#include "ABT/solver/mappings/actions/ActionMappingEntry.hpp"
...
std::unique_ptr<Action> max_action(BeliefNode const *node) {
    ...
    // print number of visits of each action
