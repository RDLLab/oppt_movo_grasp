...
public:
    ...
    virtual void serializeStep(std::ofstream& os) override {
        ...
        if (problemEnvironmentOptions_->hasVerboseOutput) {
            cout << "Belief #" << simulator_->getAgent()->getCurrentBelief()->getParentBelief() << endl;

            std::stringstream newStream;
            newStream << "After:" << endl;
            solver_->printBelief(simulator_->getAgent()->getCurrentBelief()->getParentBelief(), newStream,counter,true);
            counter = counter + 1;
...
protected:
    ...
    virtual bool updateNextBelief_(FilterResultPtr filterResult, abt::BeliefNode *nextBelief) {
        ...
        // }
        // cout << "====================================" << endl;
        // cout << "next belief contains " << nextBelief->getStates().size() << " states" << endl;        
        //////////////////////////////////////
