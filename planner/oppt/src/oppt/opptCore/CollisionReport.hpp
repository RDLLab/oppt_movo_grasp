...
{
public:
    using CollisionReport::CollisionReport;
    _NO_COPY_BUT_MOVE(DiscreteCollisionReport)

    DiscreteCollisionReport() = default;

    virtual ~DiscreteCollisionReport() = default;    
...
public:
    using CollisionReport::CollisionReport;
    _NO_COPY_BUT_MOVE(ContinuousCollisionReport)

    ContinuousCollisionReport() = default;

    virtual ~ContinuousCollisionReport() = default;    
...
public:
    using CollisionReport::CollisionReport;
    _NO_COPY_BUT_MOVE(ExtendedCollisionReport) 

    ExtendedCollisionReport() = default;

    virtual ~ExtendedCollisionReport() = default;   
