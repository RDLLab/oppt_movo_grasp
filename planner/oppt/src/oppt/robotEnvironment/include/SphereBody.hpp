 ...
 */
#ifndef SPHERE_BODY_HPP_
#define SPHERE_BODY_HPP_
#include "Body.hpp"

namespace oppt
{

class SphereBody: public BodyImpl
{
public:
	using BodyImpl::BodyImpl;
	_NO_COPY_BUT_MOVE(SphereBody)
    SphereBody(const std::string &name,
